...
export default function NewAddTechnology() {
  ...
  // useEffect(() => {
  //   if (technology) {
  //     setTitle(technology.name); // Pre-fill the title
  //     setSelectedCategories(technology.Category.split(", ")); // Pre-fill the categories
  //     setImageId(technology.team.images[0]); // Pre-fill the image
  //   }
  // }, [technology]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (technology) {
        ...
        await axios.put(`http://localhost:5300/technology/edit`, {
        ...
        await axios.post("http://localhost:5300/technology/add", technologyData);
